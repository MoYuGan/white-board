...
ItemTool_FillColorPanel::ItemTool_FillColorPanel(QColor color, QWidget *parent) :
    m_pFillColor(color),
    QWidget(parent),
...
void ItemTool_FillColorPanel::initWidget()
{
    ...
    QButtonGroup *fillColorGroup = new QButtonGroup(this);
...
void ItemTool_FillColorPanel::resize()
{
    ...
    ui->frame_fillcolor->mSetBorder(Public_Function::getScaleWidth(2));
