...
void CustomPushButton_2::paintEvent(QPaintEvent *event)
{
    ...
    int margin = PublicFunction::getScaleSize(6);
    QRect pixmapRect;
    ...
    margin = PublicFunction::getScaleSize(10);
    QRect textRect = QRect(bottomRect.x() + margin, bottomRect.y(), PublicFunction::getScaleSize(50), bottomRect.height());
    ...
    QSize size = PublicFunction::getScaleSize(QSize(17, 17));
