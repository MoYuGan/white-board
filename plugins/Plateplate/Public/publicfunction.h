...
public:
    ...
    */
    ...
    //获取旋转角度
    static qreal getRotateAngle(QPointF center, QPointF firstPoint, QPointF secondPoint)
    {
    ...
    //根据旋转中心和角度旋转data，data可以是QPoint，QPointF，QLine，QLineF，QPainterPath...
    static QVariant getRotateMap(QVariant data, qreal angle, const QPointF &center) {
    ...
    //获取线段夹角
    static qreal getTwoLineAngle(const QLineF& line1, const QLineF &line2) {
        QLineF line = line1;
        line.translate(line2.p1().x() - line1.p1().x(), line2.p1().y() - line1.p1().y());
        return getRotateAngle(line2.p1(), line2.p2(), line.p2());
    }
};
