...
public:
    ...
    void mSetText(const QString &text, const QColor &textColor = QColor(), const QColor &checkedTextColor = QColor());
    ...
    void mSetEnabled(bool enabled, const QColor &textColor = QColor());
