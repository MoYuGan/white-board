...
QT_MOC_LITERAL(1, 10, 14), // "threadFinished"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 4), // "stop"
QT_MOC_LITERAL(4, 31, 14), // "onWorkFinished"
QT_MOC_LITERAL(5, 46, 1) // "i"

    },
    "OcrThread\0threadFinished\0\0stop\0"
    "onWorkFinished\0i"
};
...
void OcrThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onWorkFinished((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (OcrThread::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OcrThread::threadFinished)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject OcrThread::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_OcrThread.data,
      qt_meta_data_OcrThread,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void OcrThread::threadFinished(int _t1)
{
