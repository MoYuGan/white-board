...
QT_MOC_LITERAL(3, 25, 13) // "setLeaveStyle"

    },
    "MenuWidget\0mouseClicked\0\0setLeaveStyle"
};
...
void MenuWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MenuWidget::mouseClicked)) {
                *result = 0;
                return;
            }
        }
