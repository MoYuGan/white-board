...
{
    QSize size = DB_ApplicationScale::getScaleSize(QSize(1000, 700));
    this->setFixedSize(size);
    ui->frame->setGeometry(6, 6, DB_ApplicationScale::getScaleWidth(281),
                           this->height() - 12);
    ui->label->setGeometry(DB_ApplicationScale::getScaleWidth(20),
    ...
    ui->label_userIcon->setGeometry(DB_ApplicationScale::getScaleWidth(20),
                           ...
                           DB_ApplicationScale::getScaleWidth(64),
                           DB_ApplicationScale::getScaleWidth(64));
    ui->label_username->setGeometry(DB_ApplicationScale::getScaleWidth(90),
                           DB_ApplicationScale::getScaleWidth(90),
                           DB_ApplicationScale::getScaleWidth(150),
                           DB_ApplicationScale::getScaleWidth(30));
    ui->label_telephone->setGeometry(DB_ApplicationScale::getScaleWidth(90),
                           DB_ApplicationScale::getScaleWidth(125),
                           DB_ApplicationScale::getScaleWidth(150),
                           DB_ApplicationScale::getScaleWidth(30));
    ui->label_management->setGeometry(DB_ApplicationScale::getScaleWidth(245),
                           DB_ApplicationScale::getScaleWidth(115),
                           DB_ApplicationScale::getScaleWidth(13),
                           DB_ApplicationScale::getScaleWidth(7));
    ui->frame_courseware->setGeometry(DB_ApplicationScale::getScaleWidth(0),
                           DB_ApplicationScale::getScaleWidth(190),
                           DB_ApplicationScale::getScaleWidth(280),
                           DB_ApplicationScale::getScaleWidth(50));
    ui->label_icon->setGeometry(DB_ApplicationScale::getScaleWidth(20),
                           DB_ApplicationScale::getScaleWidth(20),
                           DB_ApplicationScale::getScaleWidth(5),
                           DB_ApplicationScale::getScaleWidth(12));
    ui->label_courseware->setGeometry(DB_ApplicationScale::getScaleWidth(35),
                           DB_ApplicationScale::getScaleWidth(0),
                           DB_ApplicationScale::getScaleWidth(250),
                           DB_ApplicationScale::getScaleWidth(50));
    ui->label_close->setGeometry(DB_ApplicationScale::getScaleWidth(970),
                           DB_ApplicationScale::getScaleWidth(16),
                           DB_ApplicationScale::getScaleWidth(16),
                           DB_ApplicationScale::getScaleWidth(16));
    ui->stackedWidget->setGeometry(DB_ApplicationScale::getScaleWidth(320),
                           DB_ApplicationScale::getScaleWidth(50),
                           DB_ApplicationScale::getScaleWidth(641),
                           DB_ApplicationScale::getScaleWidth(621));
    ui->widget->setGeometry(0, 0,
                           DB_ApplicationScale::getScaleWidth(641),
                           DB_ApplicationScale::getScaleWidth(621));
    ui->label_5->setGeometry(DB_ApplicationScale::getScaleWidth(0),
                           DB_ApplicationScale::getScaleWidth(0),
                           DB_ApplicationScale::getScaleWidth(641),
                           DB_ApplicationScale::getScaleWidth(31));
    ui->label_headerName->setGeometry(DB_ApplicationScale::getScaleWidth(0),
                           DB_ApplicationScale::getScaleWidth(60),
                           DB_ApplicationScale::getScaleWidth(330),
                           DB_ApplicationScale::getScaleWidth(31));
    ui->label_headerTime->setGeometry(DB_ApplicationScale::getScaleWidth(330),
                           DB_ApplicationScale::getScaleWidth(60),
                           DB_ApplicationScale::getScaleWidth(78),
                           DB_ApplicationScale::getScaleWidth(31));
    ui->label_HeaderMore->setGeometry(DB_ApplicationScale::getScaleWidth(420),
                           DB_ApplicationScale::getScaleWidth(60),
                           DB_ApplicationScale::getScaleWidth(101),
                           DB_ApplicationScale::getScaleWidth(31));
    ui->label_HeaderSize->setGeometry(DB_ApplicationScale::getScaleWidth(520),
                           DB_ApplicationScale::getScaleWidth(60),
                           DB_ApplicationScale::getScaleWidth(121),
                           DB_ApplicationScale::getScaleWidth(31));
    ui->label_up->setGeometry(DB_ApplicationScale::getScaleWidth(395),
                           DB_ApplicationScale::getScaleWidth(68),
                           DB_ApplicationScale::getScaleWidth(8),
                           DB_ApplicationScale::getScaleWidth(4));
    ui->label_down->setGeometry(DB_ApplicationScale::getScaleWidth(395),
                           DB_ApplicationScale::getScaleWidth(80),
                           DB_ApplicationScale::getScaleWidth(8),
                           DB_ApplicationScale::getScaleWidth(4));
    ui->tableView->setGeometry(DB_ApplicationScale::getScaleWidth(0),
                           DB_ApplicationScale::getScaleWidth(100),
                           DB_ApplicationScale::getScaleWidth(641),
                           DB_ApplicationScale::getScaleWidth(451));
    ui->lineEdit_upload->setGeometry(DB_ApplicationScale::getScaleWidth(0),
                           DB_ApplicationScale::getScaleWidth(570),
                           DB_ApplicationScale::getScaleWidth(551),
                           DB_ApplicationScale::getScaleWidth(51));
    ui->pUpload->setGeometry(DB_ApplicationScale::getScaleWidth(550),
                           DB_ApplicationScale::getScaleWidth(570),
    ...
    ui->frame->setStyleSheet(QString("#%1{   \
                         ...
                         }").arg(ui->frame->objectName()).arg(QString::number(DB_ApplicationScale::getScaleWidth(8))));
    ui->lineEdit_upload->setStyleSheet(QString("QLineEdit{  \
                                       border: none;    \
                                       background: rgb(200, 200, 200, 200); \
                                       border-top-left-radius: %1px; \
                                       border-bottom-left-radius: %1px;  \
                                       }").arg(QString::number(DB_ApplicationScale::getScaleWidth(5))));
    ...
    font = DB_ApplicationScale::getFont(13);
...
void DB_CloudUserPanel::paintEvent(QPaintEvent *event)
{
    ...
    for(int i=0; i<border; i++)
    {
        ...
        path.addRoundedRect(j, j, this->width() - j*2, this->height() - j*2,
                            DB_ApplicationScale::getScaleWidth(8), DB_ApplicationScale::getScaleWidth(8));
        switch(i)
        {
        case 0:
            color.setAlpha(80);
