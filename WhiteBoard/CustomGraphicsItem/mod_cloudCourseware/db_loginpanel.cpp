...
{
    QSize size = DB_ApplicationScale::getScaleSize(QSize(700, 500));
    this->setFixedSize(size);
    ui->label->setFixedWidth(DB_ApplicationScale::getScaleWidth(300));
    size = DB_ApplicationScale::getScaleSize(QSize(16, 16));
    ui->label_closed->setFixedSize(size);
    ui->label_closed2->setFixedSize(size);

    QFont font = DB_ApplicationScale::getFont(12);
    ui->label_backIconText->setFont(font);
    ui->textEdit->setFont(font);
    font = DB_ApplicationScale::getFont(16);
    ui->label_version->setFont(font);

    ui->label_version->adjustSize();
    ui->label_version->move(DB_ApplicationScale::getScaleWidth(135),
