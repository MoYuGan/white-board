...
void Calculator::initLayout()
{
    ...
    ui->close->setPixmap(QPixmap(":/images/calculator/guanbi@2x.png"));
    ...
    ui->Btn_cut->setIcon(QIcon(":/images/calculator/jisuanqi1@2x.png"));
    ...
    ui->Btn_clear1->setIcon(QIcon(":/images/calculator/jisuanqi2@2x.png"));
    ...
    ui->Btn_clear2->setIcon(QIcon(":/images/calculator/jisuanqi3@2x.png"));
    ...
    ui->Btn_sign->setIcon(QIcon(":/images/calculator/jisuanqi4@2x.png"));
    ...
    ui->Btn_genhao->setIcon(QIcon(":/images/calculator/jisuanqi5@2x.png"));
    ...
    ui->Btn_percentage->setIcon(QIcon(":/images/calculator/jisuanqi6@2x.png"));
    ...
    ui->Btn_fenmu->setIcon(QIcon(":/images/calculator/jisuanqi7@2x.png"));
    ...
    ui->Btn_devide->setIcon(QIcon(":/images/calculator/jisuanqi9@2x.png"));
    ...
    ui->Btn_multiply->setIcon(QIcon(":/images/calculator/jisuanqi10@2x.png"));
    ...
    ui->Btn_minus->setIcon(QIcon(":/images/calculator/jisuanqi11@2x.png"));
    ...
    ui->Btn_add->setIcon(QIcon(":/images/calculator/jisuanqi12@2x.png"));
    ui->Btn_add->setIconSize(Public_Function::getScaleSize(30,30));

    ui->Btn_result->setFixedSize(Public_Function::getScaleSize(54,110));
    ui->Btn_result->setStyleSheet("QPushButton{border-radius:8px;background-color:rgba(20,134,250,1);}"
                                  "QPushButton:hover{background-color:rgba(20,134,250,1);}");
    ui->Btn_result->setIcon(QIcon(":/images/calculator/jisuanqi8@2x.png"));
    ui->Btn_result->setIconSize(Public_Function::getScaleSize(30,30));
