...
void DB_Register::resize()
{
    ...
    ui->horizontalLayout_14->setContentsMargins(Public_Function::getScaleSize(10), 0, 0, 0);
    ui->horizontalLayout_15->setContentsMargins(Public_Function::getScaleSize(10), 0, 0, 0);
    ...
    ui->label_serviceAgreement->setContentsMargins(Public_Function::getScaleSize(5), 0,
                                                   Public_Function::getScaleSize(5), 0);
    ui->label_privacyPolicy->setContentsMargins(Public_Function::getScaleSize(5), 0,
                                                Public_Function::getScaleSize(5), 0);
    ui->checkBox->setStyleSheet(QString("QCheckBox::indicator{"
                                                  "width:%1px;"
                                                  "height:%1px;}")
                                          .arg(QString::number(Public_Function::getScaleSize(16))));
    ui->pGetVerificationCode->setFixedWidth(Public_Function::getScaleSize(80));
